# Graph-Aware Distillation (GradBERT)
...
Then, you can go `ogbn-arxiv` or `ogbn-products` folder and run the corresponding `sh` commands to reproduce GradBERT results. 
